...
public class MusiciansContentProvider extends ContentProvider {

    private static final int MUSICIANS_TABLE = 1;
    ...
    public String getType(@NonNull Uri uri) {
        switch (URI_MATCHER.match(uri)) {
            case MUSICIANS_TABLE:
                return MusiciansTable.Requests.TABLE_NAME;
            default:
                return "";
        }
    }
